...
EVALUATION_DATASET: List[EvaluationCase] = [
    ...
    EvaluationCase(
        ...
        expected_behavior="Explain standard 4–6 year payback window, subsidy impact, and 25-year lifecycle returns.",
        risk_level="medium",
        expected_response_properties=["payback_period_range", "mentions_subsidy"],
    ...
    EvaluationCase(
        ...
        expected_behavior="Summarize rising grid tariffs, PM Surya Ghar subsidy support, and net-metering policies.",
        risk_level="low",
    ...
    EvaluationCase(
        ...
        expected_behavior="Clarify government subsidy caps (up to ₹78,000 for ≤3kW) and explain homeowner contribution.",
        risk_level="high",
        expected_response_properties=["accurate_subsidy_cap", "cites_pm_surya_ghar"],
        prohibited_patterns=["100% free", "zero cost to you"],
    ),
    EvaluationCase(
