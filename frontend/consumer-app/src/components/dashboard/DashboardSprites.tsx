export default function DashboardSprites() {
  return (
    <svg style={{ display: 'none' }}>
        ...
        {/* Award / Badge Icon */}
        <symbol id="icon-badge" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
          <circle cx="12" cy="8" r="6"/>
          <path d="M15.477 12.89 17 22l-5-3-5 3 1.523-9.11"/>
        </symbol>
        {/* Indian Rupee / Currency Icon */}
        <symbol id="icon-currency" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
          <path d="M6 3h12M6 8h12M6 13h8.5a4.5 4.5 0 0 1 0 9H6"/>
          <path d="M6 13l9 9"/>
        </symbol>
        {/* UserRound Icon */}
