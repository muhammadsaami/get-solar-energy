    ...
    <section className="ai-intelligence-section" id="aiIntelligenceSection">
              ...
              <div className="ai-insights-grid" id="aiInsightsGrid">
                  ...
                  <div className="ai-card-header">
                    ...
                    <span className="ai-confidence-ring" id="aiConfidenceRing">
                      <svg viewBox="0 0 36 36" className="ai-ring-svg">
                        ...
                        <path className="ai-ring-fill" id="aiRingFill" d="M18 2.0845 a 15.9155 15.9155 0 0 1 0 31.831 a 15.9155 15.9155 0 0 1 0 -31.831" fill="none" stroke="var(--accent-orange)" strokeWidth="2.5" strokeDasharray="0, 100"/>
                      </svg>
                      <span className="ai-ring-text" id="aiConfidenceText">--</span>
                    </span>
                  </div>
                  <div className="ai-card-body">
                    <div className="ai-readiness-display" id="aiReadinessDisplay">
                      <span className="ai-readiness-label">Solar Readiness</span>
                      <span className="ai-readiness-value" id="aiReadinessValue">--</span>
                    </div>
                    <p className="ai-summary-text" id="aiSummaryText">Run an AI analysis to get personalized solar intelligence insights.</p>
                    <div className="ai-next-action" id="aiNextAction">
                      <span className="ai-action-label">Next Best Action</span>
                      <span className="ai-action-text" id="aiNextActionText">Upload bill data to begin</span>
                    </div>
                  </div>
                </div>
                ...
                <div className="ai-insight-card" id="aiSolarReadinessCard">
                  ...
                  <div className="ai-card-body">
                    <div className="ai-score-display">
                      <span className="ai-score-value green" id="aiSolarReadinessVal">--</span>
                    ...
                    <div className="ai-readiness-metrics">
                      <div className="ai-metric-item">
                        ...
                        <span className="ai-metric-val" id="aiRoofSuitVal">--</span>
                      </div>
                      <div className="ai-metric-item">
                        <span className="ai-metric-label">Consumption Fit</span>
                        <span className="ai-metric-val" id="aiConsumptionVal">--</span>
                      </div>
                      <div className="ai-metric-item">
                        <span className="ai-metric-label">ROI Payback</span>
                        <span className="ai-metric-val" id="aiPaybackVal">--</span>
                      </div>
                      <div className="ai-metric-item">
                        <span className="ai-metric-label">CO₂ Reduced</span>
                        <span className="ai-metric-val" id="aiCO2Val">--</span>
                      </div>
                    </div>
                  </div>
                </div>
