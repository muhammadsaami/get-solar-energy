...
const technicianRouteElements = [
  ...
  <Route key="t-certifications" path={ROUTES.TECHNICIAN_CERTIFICATIONS} element={<TechnicianLocked feature="technician-certifications" stageId="PHASE_18_5" title="Certifications" />} />,
