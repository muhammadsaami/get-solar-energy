...
const MOCK_DOCUMENTS = [
  ...
  {
    id: 'doc-008',
    title: 'Net Metering Documentation Checklist',
    category: 'Compliance',
    equipment: 'None',
    difficulty: 'Beginner',
    author: 'Suresh Reddy',
    ...
    summary: 'Understanding net metering paperwork flows and the complete documentation set required for DISCOM approval.',
    tags: ['mnre', 'net-metering', 'documentation', 'policy'],
    featured: true,
    bookmarked: false,
    recentlyViewed: false,
    downloads: 1450,
